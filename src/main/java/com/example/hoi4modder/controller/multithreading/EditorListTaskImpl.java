 ...
 */
public abstract class EditorListTaskImpl extends Task<Void> implements EditorListTask {
     ...
     */
    public EditorListTaskImpl(ItemContainer<GameCharacter> container, GameCharacterList characters) {
